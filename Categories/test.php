...
if (!empty($_SESSION['login']) or !empty($_SESSION['id'])) {
	...
	unset($client);
exit ("<script> alert('Это только для пользователей')</script><html><head><meta    http-equiv='Refresh' content='0;    URL=phone.php'></head></html>");
}
...
if($result3 == true){
        echo "<html><head><meta    http-equiv='Refresh' content='0;    URL=phone.php'></head></html>";
    }
    else{
